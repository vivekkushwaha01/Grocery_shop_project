<?php
 ...
 if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    /* NOTE: while writing SELECT query dont use dash in email(i.e E-mail) */
        $sql="SELECT * FROM `costumer2` where Email='$email' AND Password='$password'";
...
?>
    ...
    <!--------------------------------------------Form--------------------------------------------------------------------->
    <form action="costumerLogin.php" method="post">
        <div class="formcontainer">
            ...
            <table id="table">
                ...
                <tr class="tablerow">
                    <td><input type="email" class="box1" name="Email" placeholder="Email address " required></td>
                </tr>
            ...
            <hr>
            <div id="click">
                <p>To create New Account <a href="costumerSignUp.php">Click Here</a></p>
            </div>
        </div>
    </form>
